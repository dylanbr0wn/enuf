	...
	return (
		<div className="flex flex-col gap-3">
			<div className="flex w-full gap-3">
				...
				>
					<svg
						className="h-4 w-4 text-[#181717] dark:text-white"
						role="img"
						viewBox="0 0 24 24"
						fill="currentColor"
			...
			<div className=" rounded border border-neutral-300 p-4 dark:border-neutral-600">
				<form onSubmit={handleSubmit(signInWithEmail)} className="flex flex-col gap-5 ">
					<h2 className="dark:text-white">Sign in with email link</h2>
					<div className="w-full ">
						<Input
							data-valid={!!errors.email}
							{...register('email')}
							placeholder="Your email address"
							className=" border-neutral-200 data-[valid='true']:border-red-200 dark:border-neutral-700"
						/>
						<Separator
							data-valid={!!errors.email}
